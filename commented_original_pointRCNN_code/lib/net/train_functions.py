...
def model_joint_fn_decorator():
    ...
    def model_fn(model, data):
        if cfg.RPN.ENABLED:
            ...
            '''data['rpn_cls_label'] : the class of each point inside the original bbox to 1
           ...
           inside the original bbox, but the x,y,z are transformed into dx, dy, dz to represent the points inside the box
           seting center of the box as point (0,0,0) like : center3d - points
        '''
        ...
        # in case of RPN only the 'pts_input' is used
