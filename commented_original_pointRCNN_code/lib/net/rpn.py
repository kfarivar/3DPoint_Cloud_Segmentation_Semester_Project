...
class RPN(nn.Module):
    ...
    # this is weight initialization but looks very weird why it is only done for specific layers
    # and why only biases are initialized for the classification head ?
