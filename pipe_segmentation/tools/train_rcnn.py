...
def create_dataloader(logger):
    ...
    # create dataloader
    train_set = pipes_rcnn_dataset(root_dir=DATA_PATH, npoints=cfg.RPN.NUM_POINTS, split=cfg.TRAIN.SPLIT, mode='TRAIN',
                                 logger=logger,
                                 classes=cfg.CLASSES,
    ...
    if args.train_with_eval:
        test_set = pipes_rcnn_dataset(root_dir=DATA_PATH, npoints=cfg.RPN.NUM_POINTS, split=cfg.TRAIN.VAL_SPLIT, mode='EVAL',
                                    logger=logger,
                                    classes=cfg.CLASSES,
...
if __name__ == "__main__":
    ...
    np.savez('train_val_losses', train_losses=train_losses, val_losses=val_losses)
